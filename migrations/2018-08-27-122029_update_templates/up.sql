                            ...
                            <td>
                                <table align="center" class="container-wrap">
                                    <tbody>
                                        <tr>
                                            <td class="top">
                                                <h1 class="title">Successful password reset</h1>
                                                <p class="desc">Dear {{user.first_name}}! Congratulations! Your password has been changed
                                                    successfully!</p>
                                                <p class="button"> <a href="http://storiqa.com" class="button-link">VISIT HOMEPAGE</a> </p>
                                                <p
                                                    class="regards">Best regards,<br>Storiqa Team</p>
                                            </td>
                                        </tr>
                                        <tr>
