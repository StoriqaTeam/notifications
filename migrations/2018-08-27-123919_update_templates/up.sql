                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="top">
                                                ...
                                                <p class="desc">Dear {{user.first_name}}! Thank you for signing up for Storiqa! In order
                                                    to finish the registration process and verify your account, please confirm
                                                    your e-mail by following the link below:</p><a href="{{verify_email_path}}/{{token}}"
                                                    class="link" target="_blank">Verify my email on Storiqa.</a> <p class="regards">Best
                                                    regards,<br>Storiqa Team</p>
                                                <p class="note"><strong>Note</strong>: If you didn’t initiate the request, please delete
                                                    this e-mail.</p>
                                            </td>
                                        </tr>
                                        <tr>
