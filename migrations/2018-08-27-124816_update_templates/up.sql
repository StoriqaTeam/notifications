                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="top">
                                                ...
                                                <p class="desc">Dear {{user.first_name}}! Your e-mail address is successfully confirmed and
                                                    registration process is completely finished.<br>Thank you for joining
                                                    us!</p>
