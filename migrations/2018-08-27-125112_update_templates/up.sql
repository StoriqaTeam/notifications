        ...
        <tr>
          <td class="">
            <table align="center" class="header-wrap">
              <tr>
                <th class="logo"><img src="https://s3.eu-central-1.amazonaws.com/dumpster.stq/img/storiqa-logo.png">
                </th>
              </tr>
            </table>
          </td>
        ...
        <tr>
          <td>
            <table align="center" class="container-wrap">
              <tbody>
              <tr>
                <td class="top"><h1 class="title">Order status change</h1>
                  <p class="desc">Dear {{user.first_name}}! Congratulations! Please be informed that the <strong
                    class="dark"><a href="{{cluster_url}}/profile/orders/{{order_slug}}" class="order-link"
                                    target="_blank">order {{order_slug}}</a></strong> status has changed to <strong
                    class="dark">{{order_state}}</strong>.</p>
                  <p class="regards">Best regards,<br>Storiqa Team</p></td>
              </tr>
              <tr>
                  ...
                  <table align="center" class="social">
                    ...
                    <tr>
                      <td class="social-icon"><a href="https://www.facebook.com/storiqa" target="_blank"> <img
                        src="https://s3.eu-central-1.amazonaws.com/dumpster.stq/img/facebook-logo.png"> </a></td>
                      <td class="social-icon"><a href="https://twitter.com/storiqa" target="_blank"> <img
                        src="https://s3.eu-central-1.amazonaws.com/dumpster.stq/img/twitter-logo.png"> </a></td>
                      <td class="social-icon"><a href="https://www.linkedin.com/showcase/24773372" target="_blank"> <img
                        src="https://s3.eu-central-1.amazonaws.com/dumpster.stq/img/linkedin-logo.png"> </a></td>
                    </tr>
                    </tbody>
                  </table>
                </td>
              ...
              <tr>
                <td>
                  <table align="center" class="footer-info">
                    <tbody>
                    <tr>
                      <td><p class="footer-text-a">For all questions send email to <a href="mailto:info@storiqa.com"
                                                                                      class="footer-text-link"
                                                                                      target="_blank">info@storiqa.com</a>
                      </p>
                        <p class="footer-text-b">You have received this letter because you had registered in
                          Storica.com.</p>
                        <p class="footer-text-c">Storiqa, 2018. All Rights Reserved.</p></td>
                    </tr>
                    </tbody>
                  </table>
                </td>
