...
pub trait MailService {
    ...
    ///
    fn send_email_with_template<E>(self, template_name: TemplateVariant, mail: E) -> Box<Future<Item = (), Error = FailureError> + Send>;
}

impl<T, M, F> MailService for Service<T, M, F>
where
